...
class AuthController extends Controller
{
    ...
    public function sign_up(Request $request)
    {
        ...
        if ($validator->fails()) {
            return $this->errorHandle($validator);
        }
        ...
        if (!env('OTP')) {
            $this->sendEmail($request->get('email'), $subject, $templatePath, $otp, $userName);
        }
    ...
    public function verifyOtp(Request $request)
    {
        ...
        if ($check_user) {
            ...
            return $this->errorRes(400, 'Invalid OTP');
        }
    }
    ...
    public function resendOtp(Request $request)
    {
        ...
        if ($user) {
            ...
            $subject = 'Resend OTP!';
            if (!env('OTP')) {
                $this->sendEmail($user->email, $subject, $templatePath, $otp, $userName);
            }
            return $this->successRes(200, 'OTP resend successfully!', $otp);
        } else {
            return $this->errorRes(400, 'Email does not exist!');
        }
    }
    ...
    public function login(Request $request)
    {
        ...
        if (Auth::attempt(['email' => $request->email, 'password' => $request->password, 'status' => 1])) {
            ...
            if ($user_detail->is_verified == 1) {
                ...
                $subject  = 'Resend OTP!';
                if (!env('OTP')) {
                    $this->sendEmail($user_detail->email, $subject, $templatePath, $otp, $userName);
                }
    ...
    public function getProfile(Request $request)
    {
        ...
        if ($user) {
            ...
            return $this->errorRes(404, 'User not found');
        }
    }
    ...
    public function editProfile(Request $request)
    {
        ...
        if ($user) {
            ...
            if ($request->has('email')) {
                ...
                if ($check) {
                    return $this->errorRes(400, 'Email already exists');
                }
                $user->email = $request->email;
            }
    ...
    public function changePassword(Request $request)
    {
        ...
        if ($check) {
            ...
            return $this->errorRes(400, 'Incorrect old password');
        }
    }
