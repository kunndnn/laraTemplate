                            ...
                            <td align="center" valign="top" bgcolor="#ffffff"
                                ...
                                <table class="col-600" width="600" height="200" border="0"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td align="left"
                                                ...
                                                <p
                                                    ...
                                                    We recieved a request to reset your Just Movies account password. Please use the following one-time password to verify yourself
                                                </p>
                                                <p
                                        ...
                                        <tr>
                                            <td align="left"
                                                style="font-family: 'Raleway', sans-serif;font-size:16px; color:#5c5a5a; font-weight: 700;">
