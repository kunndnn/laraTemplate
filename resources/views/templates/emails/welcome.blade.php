                                    ...
                                    <tbody>
                                        <tr>
                                            <td align="center" valign="top" bgcolor="#ffffff"
                                                ...
                                                <table class="col-800" width="800" height="200" border="0"
                                                    border-radius: "15px" ; align="center" cellpadding="0"
                                                    cellspacing="0">
                                                    <tbody>
                                                        <tr>
                                                            <td height="20"></td>
                                                        ...
                                                        <tr>
                                                            <td align="left"
                                                                ...
                                                                <p
                                                                    style="font-family: 'Raleway', sans-serif; font-size:25px; color:#000000; font-weight: 700;">
                                                                    <span> Hi </span> {{ $mailData['userName'] ?? "Dear" }},
                                                                </p>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td align="center"
                                                                ...
                                                                <p
                                                                    style="font-family: 'Raleway', sans-serif; font-size:17px; color:#171717; font-weight: 700;">
                                                                    YWe recieved a request to verify your account. Please use the following one-time password to verify yourself</p>
                                                            </td>
                                                        </tr>
                                                            ...
                                                            <td align="left"
                                                                ...
                                                                <p
                                                                    ...
                                                                    Your verification OTP <span
                                                                        style="font-weight: 800; font-family: poppins;">{{ $mailData['otp'] }}</span>
                                                                </p>
                                                            </td>
