                ...
                <li class="nav-item dropdown">
                    <a href="#account_menu" class="nav-link dropdown-toggle" data-toggle="dropdown" data-caret="false">
                        <span class="mr-1 d-flex-inline">
                            <span
                                class="text-light">{{ Str::ucfirst(auth()->user()->first_name) . ' ' . Str::ucfirst(auth()->user()->last_name) }}</span>
                        </span>
                        @if (auth()->user()->profile_image)
                            <img src="{{ auth()->user()->profile_image }}" alt="avatar" class="rounded-circle"
                                width="32" height="32">
                        @else
                    ...
                    <div id="account_menu" class="dropdown-menu dropdown-menu-right">
                        <div class="dropdown-item-text dropdown-item-text--lh">
                            <div>
                                <strong>{{ Str::ucfirst(auth()->user()->first_name) . ' ' . Str::ucfirst(auth()->user()->last_name) }}</strong>
                            </div>
                            <div class="text-muted">{{ auth()->user()->role == 0 ? 'Admin' : 'User' }}</div>
                        </div>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="{{ route('profile.view') }}"><i class="material-icons">edit</i>
                            Edit account</a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="{{ route('logout') }}"><i class="material-icons">exit_to_app</i>
                            Logout</a>
                    </div>
                </li>
            </ul>
