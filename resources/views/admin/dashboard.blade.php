                                            ...
                                            <td>
                                                <div class="best-product-box">
                                                    <div class="product-image">
                                                        <img loading="lazy"
                                                            src="{{ asset('admin/assets/images/product/1.png') }}"
                                                            class="img-fluid" alt="Product"
                                                            onerror="this.onerror=null; this.src='{{ asset('admin/assets/images/fallback.jpg') }}';">
                                                    </div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="best-product-box">
                                                    <div class="product-image">
                                                        <img loading="lazy"
                                                            src="{{ asset('admin/assets/images/product/2.png') }}"
                                                            class="img-fluid" alt="Product"
                                                            onerror="this.onerror=null; this.src='{{ asset('admin/assets/images/fallback.jpg') }}';">
                                                    </div>
                                                    <div class="product-name">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="best-product-box">
                                                    <div class="product-image">
                                                        <img loading="lazy"
                                                            src="{{ asset('admin/assets/images/product/3.png') }}"
                                                            class="img-fluid" alt="Product"
                                                            onerror="this.onerror=null; this.src='{{ asset('admin/assets/images/fallback.jpg') }}';">
                                                    </div>
                                                    <div class="product-name">
                    ...
                    <div class="card-body p-0">
                        <div class="category-slider no-arrow">
                            <div>
                                <div class="dashboard-category">
                                    <a href="javascript:void(0)" class="category-image">
                                        <img loading="lazy" src="{{ asset('admin/assets/svg/vegetable.svg') }}"
                            ...
                            <div>
                                <div class="dashboard-category">
                                    <a href="javascript:void(0)" class="category-image">
                                        <img loading="lazy" src="{{ asset('admin/assets/svg/cup.svg') }}"
                                            class="img-fluid" alt="image"
                                            onerror="this.onerror=null; this.src='{{ asset('admin/assets/images/fallback.jpg') }}';">
                                    </a>
                                    <a href="javascript:void(0)" class="category-name">
                            ...
                            <div>
                                <div class="dashboard-category">
                                    <a href="javascript:void(0)" class="category-image">
                                        <img loading="lazy" src="{{ asset('admin/assets/svg/meats.svg') }}"
                                            class="img-fluid" alt="image"
                                            onerror="this.onerror=null; this.src='{{ asset('admin/assets/images/fallback.jpg') }}';">
                                    </a>
                                    <a href="javascript:void(0)" class="category-name">
                            ...
                            <div>
                                <div class="dashboard-category">
                                    <a href="javascript:void(0)" class="category-image">
                                        <img loading="lazy" src="{{ asset('admin/assets/svg/breakfast.svg') }}"
                                            class="img-fluid" alt="image"
                                            onerror="this.onerror=null; this.src='{{ asset('admin/assets/images/fallback.jpg') }}';">
                                    </a>
                                    <a href="javascript:void(0)" class="category-name">
                            ...
                            <div>
                                <div class="dashboard-category">
                                    <a href="javascript:void(0)" class="category-image">
                                        <img loading="lazy" src="{{ asset('admin/assets/svg/frozen.svg') }}"
                                            class="img-fluid" alt="image"
                                            onerror="this.onerror=null; this.src='{{ asset('admin/assets/images/fallback.jpg') }}';">
                                    </a>
                                    <a href="javascript:void(0)" class="category-name">
                            ...
                            <div>
                                <div class="dashboard-category">
                                    <a href="javascript:void(0)" class="category-image">
                                        <img loading="lazy" src="{{ asset('admin/assets/svg/milk.svg') }}"
                                            class="img-fluid" alt="image"
                                            onerror="this.onerror=null; this.src='{{ asset('admin/assets/images/fallback.jpg') }}';">
                                    </a>
                                    <a href="javascript:void(0)" class="category-name">
                            ...
                            <div>
                                <div class="dashboard-category">
                                    <a href="javascript:void(0)" class="category-image">
                                        <img loading="lazy" src="{{ asset('admin/assets/svg/pet.svg') }}"
                                            class="img-fluid" alt="image"
                                            onerror="this.onerror=null; this.src='{{ asset('admin/assets/images/fallback.jpg') }}';">
                                    </a>
                                    <a href="javascript:void(0)" class="category-name">
